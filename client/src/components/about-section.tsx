        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
              En <strong className="text-kaizen-gold">Kaizen Burgos</strong>, nuestra <strong>academia de artes marciales</strong>, creemos en la mejora continua. Cada día es una oportunidad para ser mejor que ayer, tanto dentro como fuera del tatami.
            </p>
