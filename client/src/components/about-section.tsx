        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-300 mb-8 leading-relaxed">
              Nuestra academia, <strong className="text-kaizen-gold">KaizenAcademy改善Burgos</strong> ofrece clases de <strong>MMA</strong>, <strong>Brazilian Jiu-Jitsu</strong>, <strong>Kickboxing</strong> y <strong>Boxeo</strong>. Todos encuentran su lugar en nuestra academia.
            </p>
