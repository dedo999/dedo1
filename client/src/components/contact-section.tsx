        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <a href="https://wa.me/34662323282?text=¡Hola%20KaizenAcademy改善Burgos!%20👋%0A%0AMe%20gustaría%20información%20sobre%20las%20clases%20de%20artes%20marciales.%20%0A%0A¿Podrían%20contarme%20sobre:%0A•%20Horarios%20disponibles%0A•%20Precios%20y%20planes%0A•%20Clase%20gratuita%20de%20prueba%0A%0A¡Gracias!" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-green-600 hover:bg-green-700 px-6 py-4 rounded-lg font-bold text-white transition-all duration-300 transform hover:scale-105">
